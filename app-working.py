...
def home():
    ...
    if request.method == 'POST':
        ...
        if tokenizer is None:
            ...
            emoji_map = {
                'positive': '/static/gifs/positive.gif',
                'negative': '/static/gifs/negative.gif',
                'neutral': '/static/gifs/neutral.gif'
            }

    return render_template('index.html', sentiment=sentiment,emoji_gif=emoji_map[sentiment], statement=statement)
